...
To Trigger an Instance Space Analysis, one should modify the config.yaml found in the main directory of the repo, and push those changes. depending on the number of instances used, the time to complete this task will vary.